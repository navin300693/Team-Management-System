...
String researchStudent = ChatFunction.listMaster();
            ...
            <div class="container-fluid" style="margin-top: -25px;">
						...
						<div class="contact-list">
							...
							<ul class="chat-nav">
								...
								<li class="filterSearch" id="lichat<%=result.get(0).get("Id") %>">
									<a href="chat?id=<%=result.get(0).get("Id") %>"><label id="chatname<%=result.get(0).get("Id") %>"><%=result.get(0).get("FirstName") %></label></a>
								</li>
				...
				<section class="right">
						<div class="chat-head">
								...
								<form style="display: none;" id="attach" name="attach" method="post" action="chat/messageAttachStudent" enctype="multipart/form-data">
...
if (getParameterByName("id") != null) {
	...
	$("#chatName").text("Master: "+$("#chatname"+getParameterByName("id")).text());
...
function sentmessage()
{
	...
	{
		var formData = {
            "fromid": "<%=session.getAttribute("ResearchStudentId") %>",
            "toid":$("#regid").val(),
 ...
 $.ajax({
        ...
        success: function(data) {
	        	 ...
	        	 $.each(data.Data, function(index, element) {
	        		 ...
	        		 var chatMsgBaseCopy;
	        		 if(element.FromProfileId == "<%=session.getAttribute("ResearchStudentId") %>")
	        		{
